var AppProcess = (function () {
  ...
  async function videoProcess(newVideoState) {
    ...
    if (newVideoState == video_states.Camera) {
      ...
      $("#ScreenShareOnOf").html(
        "<span class='material-icons text-success'>present_to_all</span> <div className='text-success'>Stop Present Now</div>"
      );
    }
  }
  ...
  function addUser(other_user_id, connId, userNum) {
    ...
    $(".in-call-wrap-up").append(
      ' <div class="in-call-wrap d-flex justify-content-between align-items-center mb-3" id="participant_' +
        ...
        other_user_id +
        '</div> </div> <div class="participant-action-wrap display-center"> <div class="participant-action-dot display-center cursor-pointer mr-2"> <span class="material-icons">more_vert</span> </div> <div class="participant-action-pin display-center cursor-pointer mr-2"> <span class="material-icons">push_pin</span> </div> </div> </div>'
    );
